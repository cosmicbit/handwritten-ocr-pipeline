...
urlpatterns = [
    ...
    path("teacher/students/answer-sheet", views.teacher_student_answer_sheet, name="teacher_student_answer_sheet"),
    path("teacher/students/<int:studentId>/marks", views.teacher_student_marks, name="teacher_student_marks"),
    path("teacher/students/marks/update", views.teacher_update_student_marks, name="teacher_update_student_marks"),
